...
{
    internal class MT940LoaderLibrary: IDisposable
    {
        ...
        private List<LoaderFault> _operationFaults;

        public List<LoaderFault> OperationFaults
        {
            get { return _operationFaults; }
            set { _operationFaults = value; }
        }
        ...
        protected virtual void Dispose(bool disposing)
        {
            ...
            if (!_disposed)
            {
                ...
                if (disposing)
                {
                    ...
                    _headerSeperator = string.Empty;
                    _trailerSeperator = string.Empty;
                    _path = string.Empty;
                }
