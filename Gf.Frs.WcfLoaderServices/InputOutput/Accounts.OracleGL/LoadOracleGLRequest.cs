...
namespace Gf.Frs.LoaderWcfServices.InputOutput.Accounts.OracleGL
{
    ...
    /// </summary>
    [DataContract( Name = "LoadOracleGLRequest", Namespace = "http://www.gulffinance.com.sa/frs/v1/accounts/oraclegl/operations/load/request")]
    public class LoadOracleGLRequest
    {
        /// <summary>
